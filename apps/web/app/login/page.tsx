        ...
        <div className="glass-level-1 bg-[#0a0a0a]/50 rounded-2xl p-8 flex flex-col gap-8 shadow-2xl relative my-auto">
          ...
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <p className="text-sm text-[#bfc7d1]">
              Sign in to continue to FormSpace.
            </p>
          </div>
          ...
          <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center">
                ...
                <button 
                  type="button"
                  onClick={() => alert("Password reset link sent to your registered email! (Demo simulator)")}
                  className="text-xs font-semibold text-[#52a3dd] hover:text-[#90cdff] transition-colors duration-200"
                >
                  Forgot Password?
                </button>
              </div>
